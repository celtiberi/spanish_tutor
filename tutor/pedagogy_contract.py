...
# (TEACH_MODALITIES DELETED 2026-08-03, full-code-audit S2: a 46-LOC
# registry with zero readers — the contract below enforces the text moves
# directly; git history is the archive.)
